...
ECHO Disabling Non-Gamepad Controllers
:: Put any disable commands you want to run here (manually, for the time being) - get this info from the ControllerCheck.bat output.
::pnputil /disable-device "HID\[VID_XXXX&PID_XXXX]\[XXXXXXXXXXXXXXXX]"
...
ECHO Non-Gamepad Controllers disabled. Run pnputil /enable-device "[Instance ID Path]" to re-enable.
PAUSE
